...
<body>
    <div class="header">
        ...
        <p>Periodo: {{ $startDate->format('d/m/Y') }} - {{ $endDate->format('d/m/Y') }}</p>
    </div>
    ...
    <table class="summary-cards">
        <tr>
            <td>
                ...
                <span class="summary-value">${{ number_format($totalVentas, 2) }}</span>
            </td>
            <td>
            ...
            <td>
                ...
                <span class="summary-value">${{ number_format($ticketPromedio, 2) }}</span>
            </td>
        </tr>
    </table>
    ...
    <div class="footer">
        Generado el {{ date('d/m/Y H:i') }} por el sistema administrativo de Désolé.
    </div>
</body>
</html>
