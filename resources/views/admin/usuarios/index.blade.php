        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $allUsers->count() }}</p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-white">{{ $allUsers->where('is_active', true)->count() }}</p>
                </div>
            </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-700/50">
                    ...
                    <tr class="hover:bg-purple-900/20 transition-all duration-200 group">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    @if($userType === 'system_user' && $user->phone)
                        ...
                        <!-- Type -->
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium {{ $userType === 'panel_admin' ? 'bg-red-500/20 text-red-400 border border-red-500' : 'bg-blue-500/20 text-blue-400 border border-blue-500' }}">
                                <i class="{{ $userType === 'panel_admin' ? 'fa-shield-alt' : 'fa-user-tie' }} fas mr-1 text-xs"></i>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($isCurrentUser)
                                ...
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border {{ $user->is_active ? 'bg-green-500/20 text-green-400 border-green-500' : 'bg-gray-500/20 text-gray-400 border-gray-500' }}">
                                    <i class="{{ $user->is_active ? 'fas fa-check-circle' : 'fas fa-pause-circle' }} mr-1 text-xs"></i>
                            ...
                            @else
                                ...
                                <button type="button" 
                                        ...
                                        class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border transition-all duration-200 cursor-pointer {{ $user->is_active ? 'bg-green-500/20 text-green-400 border-green-500 hover:bg-green-500/30' : 'bg-gray-500/20 text-gray-400 border-gray-500 hover:bg-gray-500/30' }}"
