{{-- resources/views/admin/crm/fidelidad.blade.php --}}
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-yellow-800/40">
        ...
        <div class="text-center">
            <span class="text-yellow-400 font-bold">{{ $clientes->where('nivel_fidelidad', 1)->count() }} clientes</span>
        </div>
    </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-gray-400/40">
        ...
        <div class="text-center">
            <span class="text-gray-300 font-bold">{{ $clientes->where('nivel_fidelidad', 2)->count() }} clientes</span>
        </div>
    </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-yellow-500/40">
        ...
        <div class="text-center">
            <span class="text-yellow-400 font-bold">{{ $clientes->where('nivel_fidelidad', 3)->count() }} clientes</span>
        </div>
    </div>
</div>
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-700">
                ...
                <tr class="hover:bg-gray-750 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm font-bold text-white">{{ $cliente->puntos_fidelidad }} pts</div>
                        <div class="text-xs text-gray-400">
                            @if($cliente->puntos_fidelidad >= 100)
                                <span class="text-green-400">Listo para canjear</span>
                            @else
                                {{ 100 - $cliente->puntos_fidelidad }} pts para canje
                            @endif
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-white">{{ $cliente->total_pedidos }} pedidos</div>
                        <div class="text-xs text-gray-400">${{ number_format($cliente->total_gastado, 2) }}</div>
                    </td>
