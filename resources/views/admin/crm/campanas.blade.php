{{-- resources/views/admin/crm/campanas.blade.php --}}
@extends('admin.layout')

@section('content')
<div class="bg-red-900 p-4 mb-4 rounded">
    <h3 class="text-white font-bold">DEBUG - Variables PHP:</h3>
    <pre class="text-white">{{ print_r($estadisticas, true) }}</pre>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-orange-500/40">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-white font-bold">{{ $estadisticas['clientesInactivos'] }} clientes</span>
        </div>
        <div class="flex justify-between items-center mb-4">
            <span class="text-gray-300">Aceptan mensajes:</span>
            <span class="text-green-400 font-bold">{{ $estadisticas['inactivosConWhatsApp'] }} clientes</span>
        </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-pink-500/40">
        ...
        <div class="flex justify-between items-center mb-4">
            <span class="text-gray-300">Total:</span>
            <span class="text-white font-bold">{{ $estadisticas['cumpleanerosMes'] }} clientes</span>
        </div>
        <div class="flex justify-between items-center mb-4">
            <span class="text-gray-300">Aceptan felicitaciones:</span>
            <span class="text-green-400 font-bold">{{ $estadisticas['cumpleanerosConWhatsApp'] }} clientes</span>
        </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-blue-500/40">
        ...
        <div class="flex justify-between items-center mb-4">
            <span class="text-gray-300">Total:</span>
            <span class="text-white font-bold">{{ $estadisticas['clientesFrecuentes'] }} clientes</span>
        </div>
        <div class="flex justify-between items-center mb-4">
            <span class="text-gray-300">Aceptan mensajes:</span>
            <span class="text-green-400 font-bold">{{ $estadisticas['frecuentesConWhatsApp'] }} clientes</span>
        </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-green-500/40">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <span class="text-white font-bold">{{ $estadisticas['totalClientes'] }} clientes</span>
        </div>
        <div class="flex justify-between items-center mb-4">
            <span class="text-gray-300">Aceptan promociones:</span>
            <span class="text-green-400 font-bold">{{ $estadisticas['clientesRecibirPromociones'] }} clientes</span>
        </div>
