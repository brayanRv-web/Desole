                ...
                <div class="bg-gray-700/30 rounded-xl p-6 border border-gray-600/50">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-white mt-1">{{ $reseñas->total() }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-white mt-1">
                                {{ $reseñas->where('tipo_cliente', 'registrado')->count() }}
                            </p>
                        </div>
                ...
                <div class="bg-gray-700/30 rounded-xl p-6 border border-gray-600/50">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-white mt-1">
                                {{ $reseñas->where('tipo_cliente', 'anonimo')->count() }}
                            </p>
                        </div>
                ...
                <div class="bg-gray-700/30 rounded-xl p-6 border border-gray-600/50">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-white mt-1">
                                {{ number_format($reseñas->avg('calificacion') ?? 0, 1) }}/5
                            </p>
                        </div>
                            ...
                            <tr class="border-b border-gray-700/50 hover:bg-gray-600/30 transition-all duration-200">
                                <td class="py-4 px-6">
                                    <div>
                                        ...
                                        {{-- ✅ NUEVO: Mostrar tipo de cliente --}}
                                        <div class="mt-1">
                                            @if($reseña->tipo_cliente === 'registrado' && $reseña->cliente)
                                                ...
                                                <small class="text-yellow-400 text-xs">
                                                    🛒 {{ $reseña->cliente->total_pedidos }} pedidos
                                                </small>
                                            @else
                                ...
                                <td class="py-4 px-6">
                                <div class="flex items-center gap-2">
                                    <form action="{{ route('admin.resenas.destroy', $reseña->id) }}" 
                                    ...
                                    {{-- ✅ NUEVO: Botón para ver perfil del cliente registrado --}}
                                    @if($reseña->tipo_cliente === 'registrado' && $reseña->cliente)
                                    <a href="{{ route('admin.clientes.show', $reseña->cliente->id) }}" 
