            ...
            <nav class="space-y-2">
                    ...
                    <a href="{{ url('admin/') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition
                            {{ request()->is('admin') || request()->is('admin/') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
                    ...
                    <a href="{{ url('admin/productos') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition relative
                            {{ request()->is('admin/productos*') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
                    ...
                    <a href="{{ url('admin/pedidos') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition
                            {{ request()->is('admin/pedidos*') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
                    ...
                    <a href="{{ url('admin/promociones') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition
                            {{ request()->is('admin/promociones*') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
                    ...
                    <a href="{{ url('admin/horarios') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition
                            {{ request()->is('admin/horarios*') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
                    ...
                    <a href="{{ url('admin/usuarios') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition
                            {{ request()->is('admin/usuarios*') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
                    ...
                    <a href="{{ url('admin/reportes') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition
                            {{ request()->is('admin/reportes*') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
                    ...
                    <a href="{{ url('admin/reseñas') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg transition
                            {{ request()->is('admin/reseñas*') ? 'bg-green-600 text-white' : 'hover:bg-green-600/20 hover:text-green-400 text-gray-300' }}">
