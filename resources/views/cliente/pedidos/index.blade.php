                        ...
                        <div class="p-6">
                            <div class="flex justify-between items-start mb-4">
                                ...
                                <div class="text-right">
                                    <span data-pedido-id="{{ $pedido->id }}" class="inline-block px-3 py-1 rounded-full text-sm 
                                        @if($pedido->estado == 'pendiente') bg-yellow-500/20 text-yellow-400
                                        @elseif($pedido->estado == 'preparando') bg-blue-500/20 text-blue-400
                                        @elseif($pedido->estado == 'listo') bg-green-500/20 text-green-400
                                        @elseif($pedido->estado == 'entregado') bg-purple-500/20 text-purple-400
                ...
                <script>
                    (function(){
                        ...
                        async function pollAll() {
                            ...
                            // Build array of ids
                            const ids = els.map(e => e.getAttribute('data-pedido-id'));

                            // Fetch each (simple approach)
                            for (const el of els) {
