        ...
        <div class="row mt-5"> <!-- Reducido espacio -->
            <div class="col-12">
                ...
                <div class="text-center mt-4"> <!-- Reducido espacio -->
                    <a href="{{ route('reseñas.index') }}" class="btn btn-outline-warning btn-sm"> <!-- Botón más pequeño -->
