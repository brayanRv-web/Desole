...
function cargarResumenCarrito() {
    ...
    if (items.length === 0) {
        window.location.href = "<?php echo e(route('cliente.carrito')); ?>";
        return;
    }
    ...
    items.forEach(item => {
        ...
        const imgSrc = item.imagen 
            ...
            : "<?php echo e(asset('assets/placeholder.svg')); ?>";
...
function procesarCompra(e) {
    ...
    fetch("<?php echo e(route('api.carrito.finalizar')); ?>", {
        method: "POST",
        headers: {
    ...
    .then(data => {
        if (data.success) {
            ...
            Toast.fire({
                ...
                window.location.href = "<?php echo e(route('cliente.pedidos.index')); ?>";
            });
        } else {
...
<?php echo $__env->make('cliente.layout.cliente', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\josxp\Documents\desole\Desole\resources\views/cliente/carrito/checkout.blade.php ENDPATH**/ ?>