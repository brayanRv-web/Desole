...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <form action="<?php echo e(route('admin.reportes.index')); ?>" method="GET" class="flex flex-wrap items-end gap-3 bg-gray-800 p-3 rounded-lg border border-gray-700">
            <div>
            ...
            <button type="submit" formaction="<?php echo e(route('admin.reportes.pdf')); ?>" class="bg-red-600 hover:bg-red-700 text-white px-4 py-1.5 rounded text-sm font-medium transition shadow-lg shadow-red-900/20 h-[34px]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <h3 class="text-3xl font-bold text-white mt-1">$<?php echo e(number_format($totalVentas, 2)); ?></h3>
        ...
        <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <h3 class="text-3xl font-bold text-white mt-1"><?php echo e($totalPedidos); ?></h3>
        ...
        <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 shadow-lg relative overflow-hidden group">
            ...
            <div class="relative z-10">
                ...
                <h3 class="text-3xl font-bold text-white mt-1">$<?php echo e(number_format($ticketPromedio, 2)); ?></h3>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\josxp\Documents\desole\Desole\resources\views/admin/reportes/index.blade.php ENDPATH**/ ?>