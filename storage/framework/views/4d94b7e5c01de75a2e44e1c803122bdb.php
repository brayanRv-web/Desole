...
<div class="flex flex-col space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-400 mt-2">Modificar horario para <?php echo e($horario->dia_semana_completo); ?></p>
        </div>
    ...
    <div class="bg-gray-800/50 rounded-2xl border border-blue-700/30 shadow-xl overflow-hidden">
        <div class="p-6">
            <form action="<?php echo e(route('admin.horarios.update', $horario)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="bg-gray-700/30 rounded-xl p-6 border border-blue-500/20">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="text-white text-lg font-semibold"><?php echo e($horario->dia_semana_completo); ?></p>
                            </div>
                            <div>
                                <label class="text-gray-400 text-sm">Horario actual</label>
                                <p class="text-white text-lg"><?php echo e($horario->horario_formateado); ?></p>
                            </div>
                            <div>
                                <label class="text-gray-400 text-sm">Estado actual</label>
                                <p class="text-<?php echo e($horario->activo ? 'green' : 'red'); ?>-400 font-semibold">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="time" 
                                       id="apertura"
                                       name="apertura" 
                                       value="<?php echo e($horario->apertura->format('H:i')); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="time" 
                                       id="cierre"
                                       name="cierre" 
                                       value="<?php echo e($horario->cierre->format('H:i')); ?>"
                                       class="w-full bg-gray-600 border border-gray-500 rounded-lg px-4 py-3 text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 transition text-lg"
                                       required>
                                <?php $__errorArgs = ['cierre'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
    ...
    <div class="bg-gray-800/30 rounded-xl p-6 border border-green-500/20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="text-center p-4 bg-gray-700/50 rounded-lg">
                ...
                <p class="text-white text-xl font-semibold mt-2"><?php echo e($horario->horario_formateado); ?></p>
                <p class="text-<?php echo e($horario->activo ? 'green' : 'red'); ?>-400 text-sm mt-1">
                    <?php echo e($horario->activo ? 'Activo' : 'Inactivo'); ?>
            ...
            <div class="text-center p-4 bg-gray-700/50 rounded-lg">
                ...
                <p class="text-<?php echo e($horario->estaAbierto() ? 'green' : 'red'); ?>-400 text-xl font-semibold mt-2">
                    <?php echo e($horario->estaAbierto() ? 'Abierto' : 'Cerrado'); ?>

                </p>
                <p class="text-gray-400 text-sm mt-1">
                    <?php echo e($horario->estaAbierto() ? 'Disponible para clientes' : 'No disponible'); ?>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Desole\resources\views/admin/horarios/edit.blade.php ENDPATH**/ ?>