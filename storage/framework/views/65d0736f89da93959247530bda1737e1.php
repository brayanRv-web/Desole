            ...
            <?php else: ?>
                ...
                <div class="cart-summary border-t border-zinc-600 pt-6 mt-6 flex justify-between items-center">
                    ...
                    <div class="flex gap-4">
                        ...
                        <a href="<?php echo e(route('cliente.carrito.pago')); ?>" class="bg-green-500 hover:bg-green-600 text-white px-8 py-3 rounded-lg font-semibold transition duration-300 transform hover:scale-105 flex items-center">
...
<!-- Agregar JavaScript para manejar el submit -->
<script>
...
<?php echo $__env->make('cliente.layout.cliente', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Desole\resources\views/cliente/carrito.blade.php ENDPATH**/ ?>