    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-blue-500/40">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white"><?php echo e($estadisticas['totalClientes']); ?></p>
            </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-green-500/40">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white"><?php echo e($estadisticas['clientesNuevosMes']); ?></p>
            </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-purple-500/40">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white"><?php echo e($estadisticas['pedidosRecurrentes']); ?></p>
            </div>
    ...
    <div class="bg-gray-800 p-6 rounded-xl border border-yellow-500/40">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-white"><?php echo e($estadisticas['clientesFrecuentes']); ?></p>
            </div>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <a href="<?php echo e(route('admin.crm.clientes')); ?>" 
    ...
    <a href="<?php echo e(route('admin.crm.campanas')); ?>" 
    ...
    <a href="<?php echo e(route('admin.crm.fidelidad')); ?>" 
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\josxp\Documents\desole\Desole\resources\views/admin/crm/index.blade.php ENDPATH**/ ?>