<?php $__env->startSection('title', 'Dashboard - DÉSOLÉ'); ?>
                    ...
                    <div class="visit-badge">
                        ...
                        <strong class="visit-date">
                            <?php if($cliente->ultima_visita): ?>
                                <?php echo e($cliente->ultima_visita->format('d/m/Y')); ?>
    ...
    <div class="dashboard-content">
        ...
        <div class="main-section">
                ...
                <div class="card-body-custom">
                    <div class="personal-info-grid">
                        <div class="info-group">
                            ...
                            <p class="info-value"><?php echo e($cliente->nombre); ?></p>
                        </div>
                        
                        <div class="info-group">
                            <label class="info-label">Email</label>
                            <p class="info-value"><?php echo e($cliente->email); ?></p>
                        </div>
                        
                        <div class="info-group">
                            <label class="info-label">Teléfono</label>
                            <p class="info-value"><?php echo e($cliente->telefono); ?></p>
                        </div>
            ...
            <div class="orders-card">
                ...
                <div class="card-body-custom">
                    <?php if(isset($pedidosRecientes) && $pedidosRecientes->count() > 0): ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="order-status">
                                            <span data-pedido-id="<?php echo e($pedido->id); ?>" class="status-badge status-<?php echo e($pedido->estado ?? $pedido->status); ?>">
                                                <?php echo e(ucfirst($pedido->estado ?? $pedido->status)); ?>

                                            </span>
                                        </td>
                                        <td class="order-actions">
                                            <a href="<?php echo e(route('cliente.pedidos.show', $pedido->id)); ?>" class="btn-action">Ver Detalles</a>
                                        </td>
                                    </tr>
        ...
        <div class="sidebar-section">
            <div class="actions-card">
                        ...
                        <div class="actions-grid">
                            <a href="<?php echo e(route('cliente.menu')); ?>" class="action-btn secondary">
                                <i class="fas fa-utensils"></i>
                                <span>Ver Menú y Ordenar</span>
                            </a>
                            <a href="<?php echo e(route('cliente.pedidos.index')); ?>" class="action-btn secondary">
                                <i class="fas fa-history"></i>
                                <span>Historial de Pedidos</span>
                            </a>
                            <a href="<?php echo e(route('cliente.perfil')); ?>" class="action-btn secondary">
                                ...
                                <div class="promotions-list">
                                    ...
                                    <div class="promotion-item">
                                        <div class="promotion-header">
                                            <h4><?php echo e($promocion->nombre); ?></h4>
                                            <?php if($promocion->descuento): ?>
                                                <span class="discount-badge"><?php echo e($promocion->descuento); ?>% OFF</span>
                                            <?php endif; ?>
                                        </div>
                                        <p class="promotion-desc"><?php echo e($promocion->descripcion); ?></p>
                                        <div class="promotion-footer">
                                            <small class="promotion-date">
                                                <i class="fas fa-calendar me-1"></i>
                                                <?php if($promocion->fecha_fin): ?>
                                                    Válida hasta: <?php echo e($promocion->fecha_fin->format('d/m/Y')); ?>
...
<?php echo $__env->make('cliente.layout.cliente', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\josxp\Documents\desole\Desole\resources\views/cliente/dashboard.blade.php ENDPATH**/ ?>