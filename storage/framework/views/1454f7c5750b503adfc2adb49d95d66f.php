...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-gray-800/50 border border-green-700/30 rounded-2xl shadow-xl overflow-hidden">
        <form action="<?php echo e(route('admin.productos.update', $producto->id)); ?>" method="POST" enctype="multipart/form-data" class="p-8 space-y-8">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="categoria_id" id="categoria_id" required
                            ...
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($categoria->id); ?>" <?php echo e(old('categoria_id', $producto->categoria_id) == $categoria->id ? 'selected' : ''); ?> class="text-white">
                ...
                <div class="space-y-6">
                            ...
                            <div class="mb-4 p-4 bg-gray-700/30 rounded-xl border border-gray-600/50">
                                ...
                                <div class="flex items-center gap-4">
                                    <img src="<?php echo e(asset('storage/' . $producto->imagen)); ?>"
                                         alt="Imagen actual de <?php echo e($producto->nombre); ?>"
                                         class="w-20 h-20 object-cover rounded-lg border-2 border-green-500/50 shadow-lg">
                                    <div class="flex-1">
                                        <p class="text-white text-sm font-medium"><?php echo e($producto->nombre); ?></p>
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="estado" id="estado" required
                                class="w-full border border-gray-600 bg-gray-700/50 text-white px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200">
                            <option value="activo" <?php echo e(old('status', $producto->status) == 'activo' ? 'selected' : ''); ?> class="text-white">
                                🟢 Activo
                            </option>
                            <option value="inactivo" <?php echo e(old('status', $producto->status) == 'inactivo' ? 'selected' : ''); ?> class="text-white">
                                ⚪ Inactivo
                            </option>
                            <option value="agotado" <?php echo e(old('status', $producto->status) == 'agotado' ? 'selected' : ''); ?> class="text-white">
                                🔴 Agotado
                            </option>
                        </select>
            ...
            <div class="space-y-2">
                ...
                <textarea name="descripcion" id="descripcion" rows="4"
                          ...
                          class="w-full border border-gray-600 bg-gray-700/50 text-white px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200 resize-none placeholder-gray-500"><?php echo e(old('descripcion', $producto->descripcion)); ?></textarea>
                <p class="text-xs text-gray-400 flex items-center gap-1">
                    <i class="fas fa-info-circle text-xs"></i>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\josxp\Documents\desole\Desole\resources\views/admin/productos/edit.blade.php ENDPATH**/ ?>