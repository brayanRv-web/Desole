                    ...
                    <tr class="hover:bg-green-900/20 transition-all duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 py-1 rounded-lg text-xs font-semibold
                                {{ $pedido->estado === 'pendiente' ? 'bg-yellow-500/20 text-yellow-400' : '' }}
                                {{ $pedido->estado === 'preparando' ? 'bg-blue-500/20 text-blue-400' : '' }}
                                {{ $pedido->estado === 'listo' ? 'bg-green-500/20 text-green-400' : '' }}
                                {{ $pedido->estado === 'entregado' ? 'bg-purple-500/20 text-purple-400' : '' }}
                                {{ $pedido->estado === 'cancelado' ? 'bg-red-500/20 text-red-400' : '' }}">
