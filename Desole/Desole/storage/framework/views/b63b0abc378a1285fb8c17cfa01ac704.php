...
<div class="container mx-auto px-4 py-16">
    <div class="max-w-4xl mx-auto bg-zinc-800 rounded-2xl shadow-xl overflow-hidden border border-zinc-700 p-8">
        <div class="flex justify-between items-start mb-8">
            <div>
                <h1 class="text-3xl font-bold text-green-400 mb-2">Pedido #<?php echo e(str_pad($pedido->id, 4, '0', STR_PAD_LEFT)); ?></h1>
                <p class="text-gray-400">Fecha: <?php echo e($pedido->created_at->format('d/m/Y H:i')); ?></p>
            </div>
            <div class="text-right">
                <span class="inline-block px-4 py-2 rounded-full text-sm font-bold 
                    <?php echo e($pedido->estado == 'pendiente' ? 'bg-yellow-500/20 text-yellow-500' : ''); ?>

                    <?php echo e($pedido->estado == 'completado' ? 'bg-green-500/20 text-green-500' : ''); ?>

                    <?php echo e($pedido->estado == 'cancelado' ? 'bg-red-500/20 text-red-500' : ''); ?>">
                    <span id="pedido-estado"><?php echo e(ucfirst($pedido->estado)); ?></span>
                </span>
            </div>
        </div>
        ...
        <div class="bg-zinc-700/30 rounded-xl p-6 mb-8 border border-zinc-600">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="text-white font-medium capitalize"><?php echo e($pedido->metodo_pago ?? 'No especificado'); ?></p>
                </div>
                <div>
                    <p class="text-gray-400 text-sm">Total a Pagar</p>
                    <p class="text-green-400 font-bold text-xl">$<?php echo e(number_format($pedido->total, 2)); ?></p>
                </div>
            </div>
            ...
            <?php if($pedido->metodo_pago == 'transferencia'): ?>
                <div class="mt-6 pt-6 border-t border-zinc-600">
                    ...
                    <div class="bg-zinc-800 p-4 rounded-lg text-sm text-gray-300 space-y-2">
                        ...
                        <p><span class="text-gray-500">Concepto:</span> Pedido #<?php echo e(str_pad($pedido->id, 4, '0', STR_PAD_LEFT)); ?></p>
                        <div class="mt-4 text-xs text-gray-500">
                            * Por favor envía tu comprobante de pago por WhatsApp al <?php echo e(config('contacto.whatsapp')); ?>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-gray-300">
                    <?php $__currentLoopData = $pedido->items ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr class="border-b border-zinc-700/50">
                            <td class="py-4"><?php echo e($nombre); ?></td>
                            <td class="py-4 text-center"><?php echo e($cantidad); ?></td>
                            <td class="py-4 text-right">$<?php echo e(number_format($precio, 2)); ?></td>
                            <td class="py-4 text-right font-medium text-white">$<?php echo e(number_format(($precio * $cantidad), 2)); ?></td>
                        </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="py-4 text-right text-2xl font-bold text-green-400">$<?php echo e(number_format($pedido->total, 2)); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
        ...
        <div class="mt-8 flex justify-end">
            <a href="<?php echo e(route('cliente.pedidos.index')); ?>" class="inline-flex items-center px-6 py-3 bg-zinc-700 hover:bg-zinc-600 text-white rounded-lg transition duration-300">
...
<?php echo $__env->make('cliente.layout.cliente', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Desole\Desole\resources\views/cliente/pedidos/show.blade.php ENDPATH**/ ?>