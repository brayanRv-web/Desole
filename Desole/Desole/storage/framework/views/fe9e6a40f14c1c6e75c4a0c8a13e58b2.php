  ...
  <nav class="nav">
    ...
    <?php if(isset($isProfilePage) && $isProfilePage): ?>
      ...
      <ul class="nav-links">
        ...
        <li><a href="<?php echo e(route('faq')); ?>"><i class="fas fa-question-circle"></i> Ayuda</a></li>
      </ul>
...
</header><?php /**PATH C:\xampp\htdocs\Desole\Desole\resources\views/public/secciones/_navbar.blade.php ENDPATH**/ ?>