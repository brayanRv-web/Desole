...
<section class="py-16">
  <div class="container mx-auto px-4">
      ...
      <!-- Render de FAQ -->
      @foreach ($faq as $titulo => $preguntas)
      <section class="mb-10" data-aos="fade-up">
          <h2 class="section-title text-left mb-4" style="color: #ffffffff">{{ $titulo }}</h2>
      ...
      <div class="mt-16 text-center border-t border-gray-800 pt-10" data-aos="fade-up">
          ...
          <a href="{{ url('/#contacto') }}" class="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-full transition-all transform hover:scale-105 shadow-lg shadow-green-900/20">
