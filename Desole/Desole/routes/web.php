...
Route::middleware(['auth:cliente'])
    ...
    ->group(function () {
        ...
        // Sincronizar carrito (JS -> Session)
        Route::post('/carrito/sync', [CarritoController::class, 'sincronizar'])
            ->name('carrito.sync');

        // Página de selección de método de pago (Checkout)
        Route::get('/pagar', [CarritoController::class, 'checkout'])
